...
{
    public partial class FormJos : Form
    {
        Thread th;
        ...
        private void FormJos_Load(object sender, EventArgs e)
        {
            this.Hide();
            PBNo.Visible = false;
        ...
        {
            string query = "SELECT COUNT(*) FROM [AlertManager].[dbo].[Jos] WHERE EmployeeID = @searchString AND Notification = 1";
        ...
        {
            string query = "SELECT TOP (1) [Message] FROM [AlertManager].[dbo].[Notification] WHERE Area = 'JOSActions'";
            using (SqlCommand command = new SqlCommand(query, connection))
            {
        ...
        {
            Application.Run(new FormGapAnalysis());
        ...
        private void Msg_install()
        {
            ...
            string Themessage = @"<html>
                                ...
                                <table width=""100%"">
                                <tr>
                                <h1 style=""text-align:center"">JOS Pending Actions</h1>
                                ...
                                <p style=""text-align:center"">reportou o término de suas ações em: " + DateTime.Now + @", geltileza verificar.</p>
            ...
            sendHtmlEmail("no-reply@jabil.com", "JOS_Notification@jabil.com", lblMail.Text, Themessage, "JOS NOTIFY", "WARNING", "corimc04", 25);
        }
