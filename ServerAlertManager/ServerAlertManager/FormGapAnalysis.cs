...
{
    public partial class FormGapAnalysis : Form
    {
        Thread th;
        ...
        private void FormGapAnalysis_Load(object sender, EventArgs e)
        {
            this.Hide();
            PBNo.Visible = false;
        ...
        {
            string query = "SELECT COUNT(*) FROM [AlertManager].[dbo].[GapAnalysis] WHERE EmployeeID = @searchString AND Notification = 1";
        ...
        {
            string query = "SELECT TOP (1) [Message] FROM [AlertManager].[dbo].[Notification] WHERE Area = 'GAPActions'";
            using (SqlCommand command = new SqlCommand(query, connection))
            {
        ...
        {
            Application.Run(new FormLpaBel());
        ...
        void Done()
        {
            Process.Start("https://jdoc.jabil.com/app/Forms");
            this.Close();
        ...
        {
            string Logo = "http://brbelm0apps02/5simages/Jabil_FullColorLogo.png";
            var year = DateTime.Now.Year;
            string Themessage = @"<html>
                                <body>
                                <table width=""100%"">
                                <tr>
                                <h1 style=""text-align:center"">Gap Analysis </h1>
                                <p style=""text-align:center"">Olá  Administrator,</p>
                                <p style=""text-align:center"">O Colaborador: " + label7.Text + @"  e-mail: " + lblMail.Text + @".</p>
                                <p style=""text-align:center"">Reportou a revisão de seus documentos em: " + DateTime.Now + @", geltileza verificar.</p>
            ...
            sendHtmlEmail("no-reply@jabil.com", "egleia_souza@jabil.com", lblMail.Text, Themessage, "Gap Analysis", "WARNING", "corimc04", 25);
        }
