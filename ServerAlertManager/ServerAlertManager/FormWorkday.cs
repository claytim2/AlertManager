...
namespace ServerAlertManager
{
    ...
    public partial class FormWorkday : Form
    {
        Thread th;
        ...
        {
            string query = "SELECT COUNT(*) FROM [AlertManager].[dbo].[Workday] WHERE EmployeeID = @searchString AND Notification = 1";
        ...
        private void Msg_install()
        {
            ...
            string Themessage = @"<html>
                                ...
                                <table width=""100%"">
                                <tr>
                                <h1 style=""text-align:center"">Workday Pending Training</h1>
            ...
            sendHtmlEmail("no-reply@jabil.com", "raquel_nascimento@jabil.com", lblMail.Text, Themessage, "WORDAY NOTIFY", "WARNING", "corimc04", 25);
        }
