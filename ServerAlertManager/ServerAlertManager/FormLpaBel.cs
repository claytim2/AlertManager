...
{
    public partial class FormLpaBel : Form
    {
        Thread th;
        ...
        private void FormLpaBel_Load(object sender, EventArgs e)
        {
            this.Hide();
            PBNo.Visible = false;
            LblPc.Visible = true;
        ...
        {
            string query = "SELECT COUNT(*) FROM [AlertManager].[dbo].[LpaBel] WHERE EmployeeID = @searchString AND Notification = 1";
        ...
        {
            string query = "SELECT TOP (1) [Message] FROM [AlertManager].[dbo].[Notification] WHERE Area = 'LPABActions'";
            using (SqlCommand command = new SqlCommand(query, connection))
            {
        ...
        void Done()
        {
            Process.Start("https://brbelm0apps01/LPAEletronico/Actions");
            this.Close();
        ...
        {
            string Logo = "http://brbelm0apps02/5simages/Lpa.png";
            var year = DateTime.Now.Year;
            string Themessage = @"<html>
                                <body>
                                <table width=""100%"">
                                <tr>
                                <h1 style=""text-align:center"">LPA BEL Pending Actions</h1>
                                <p style=""text-align:center"">Olá  Administrator,</p>
                                <p style=""text-align:center"">O Colaborador: " + label7.Text + @"  Matricula: " + lLblWdid.Text + @".</p>
                                <p style=""text-align:center"">reportou que recisa de sua ajuda em: " + DateTime.Now + @", geltileza verificar.</p>
            ...
            sendHtmlEmail("no-reply@jabil.com", "alessandra_costa@jabil.com", lblMail.Text, Themessage, "LPA NOTIFY", "WARNING", "corimc04", 25);
        }
